...
class EnhancedCapsuleGenerator:
    ...
    def _create_project_structure(
        ...
        is_api = "api" in request.description.lower()
        is_web = any(word in request.description.lower() for word in ["web", "react", "frontend"])
        ...
        if is_api:
            ...
            files.update({
                ...
                "Dockerfile": self._generate_dockerfile("api"),
            ...
            files.update({
                ...
                "src/index.js": self._generate_index_js(),
                "package.json": self._generate_package_json(request.description),
